...
// Tigerfish at various skill levels.
// Skill 0 .. 19 now covers CCRL Blitz Elo from 1320 to 3190, approximately
// Reference: prior engine research on variable-skill play.
struct Skill {
...
class Worker {
   ...
   private:
    ...
    // Tigerfish: current search personality, refreshed each iterative_deepening()
    TigerConfig tigerCfg;
    ...
    friend class Tigerfish::ThreadPool;
