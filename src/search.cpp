...
void Search::Worker::iterative_deepening() {
    ...
    // Tigerfish: read personality from UCI options once per search.
    // All threads share the same OptionsMap so the read is consistent.
    tigerCfg.enabled    = bool(options["TigerMode"]);
